...
while not gameExit:
	...
	pygame.draw.circle(gameDisplay, green, (67, 109), 40, 5)
	pygame.draw.circle(gameDisplay, green, (600, 200), 40, 0)
	pygame.draw.circle(gameDisplay, green, (700, 200), 40, 0)
	pygame.draw.rect(gameDisplay, black, [500,200, 100, 10])
